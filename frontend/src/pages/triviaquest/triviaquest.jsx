        ...
        <main className={`trivia-quest-page ${battle ? "is-battle-active" : ""}`}>
            <div className="quest-shell">
                ...
                <section className="quest-panel quest-leaderboard">
                    <div className="quest-section-heading">
                        <div><p className="quest-eyebrow">Weekly standings</p><h2>Team damage leaderboard</h2></div>
                    </div>
                        ...
                        <div className="quest-ranking-list">
                            {leaderboard.map((entry) => (
                                <article key={entry.teamId} className={entry.teamId === team?.id ? "is-current" : ""}>
                                    ...
                                    <div>
                                        <strong>{entry.teamName}{entry.defeated ? " · Boss defeated" : ""}</strong>
                                        <span>{entry.memberCount} players · {entry.questionsAnswered} questions</span>
                                    </div>
